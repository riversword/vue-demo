  ...
  <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show': loginModalFlag}">
    <div class="md-modal-inner">
      <div class="md-top">
        ...
        <button v-on:click="loginModalFlag = false" class="md-close">Close</button>
      </div> 
        ...
        <div class="confirm-tips">
          ...
          <ul>
            ...
            <li class="regi_form_input noMargin">
              ...
              <input v-model="userPwd" type="password" tabindex="2" name="password" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text">
            </li>
          </ul>
        </div> 
        <div class="login-wrap">
          <a href="javascript:;" class="btn-login" v-on:click="login">登  录</a>
        </div>
      </div>
    </div>
  </div>
  <div class="md-overlay" v-show="loginModalFlag" v-on:click="loginModalFlag = false"></div>
</header>
</template>
<style type="text/css">
...
export default{
  ...
  methods: { //不写属性 function，用es6直接写函数
    login() {
